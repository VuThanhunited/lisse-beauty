    ...
    <div className={styles.container}>
      ...
      >
        <LoginForm
          ...
          title="Lisse Beauty Admin"
          subTitle="Hệ thống quản trị trung tâm làm đẹp Lisse Beauty"
          initialValues={{
            autoLogin: true,
          }}
          actions={[
            <FormattedMessage
              ...
              defaultMessage="Các cách đăng nhập khác"
            />,
        ...
        >
            ...
            <>
              <ProFormText
                ...
                placeholder={intl.formatMessage({
                  ...
                  defaultMessage: "Nhập tên đăng nhập: admin hoặc user",
                })}
                rules={[
                  {
                    required: true,
          ...
          {status === "error" && loginType === "mobile" && (
            <LoginMessage content="Mã xác thực không đúng" />
          )}
          {type === "mobile" && (
            <>
              <ProFormText
                  ...
                  },
                  {
                    ...
                    message: (
                      <FormattedMessage
                        ...
                        defaultMessage="Định dạng số điện thoại không đúng!"
                      />
                    ),
                  },
                ]}
